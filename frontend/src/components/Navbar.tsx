    ...
    <header className="sticky top-0 z-10 bg-[#fafafa] dark:bg-[#141411] border-b border-[rgba(14,15,12,0.08)] dark:border-[rgba(232,235,230,0.08)]">
      <div className="max-w-5xl mx-auto px-3 sm:px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setMobileOpen(!mobileOpen)} className="sm:hidden p-3 min-h-[44px] min-w-[44px] text-[#686868] dark:text-[#898989] hover:text-[#0e0f0c] dark:hover:text-[#e8ebe6] rounded-lg transition" aria-label="Menu">
            {mobileOpen ? '✕' : '☰'}
          </button>
        </div>
        <div className="flex items-center gap-1">
          <div className="hidden sm:flex items-center gap-1">
            <button
              ...
              className={`px-3 py-1.5 text-sm rounded-full transition ${active === 'sessions' ? 'bg-[#f0f1ee] dark:bg-[#2a2c27] text-[#0e0f0c] dark:text-[#e8ebe6] font-semibold' : 'font-medium text-[#686868] dark:text-[#898989] hover:text-[#0e0f0c] dark:hover:text-[#e8ebe6] hover:bg-[#f0f1ee] dark:hover:bg-[#1e201c]'}`}
            >
              Sessions
            </button>
            <button
              onClick={() => router.push('/market')}
              className={`px-3 py-1.5 text-sm rounded-full transition ${active === 'market' ? 'bg-[#f0f1ee] dark:bg-[#2a2c27] text-[#0e0f0c] dark:text-[#e8ebe6] font-semibold' : 'font-medium text-[#686868] dark:text-[#898989] hover:text-[#0e0f0c] dark:hover:text-[#e8ebe6] hover:bg-[#f0f1ee] dark:hover:bg-[#1e201c]'}`}
            >
              Market
            </button>
            <button
              onClick={() => router.push('/glossary')}
              className={`px-3 py-1.5 text-sm rounded-full transition ${active === 'glossary' ? 'bg-[#f0f1ee] dark:bg-[#2a2c27] text-[#0e0f0c] dark:text-[#e8ebe6] font-semibold' : 'font-medium text-[#686868] dark:text-[#898989] hover:text-[#0e0f0c] dark:hover:text-[#e8ebe6] hover:bg-[#f0f1ee] dark:hover:bg-[#1e201c]'}`}
            >
              Glosarium
            </button>
