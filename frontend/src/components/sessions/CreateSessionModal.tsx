...
export function CreateSessionModal({ strategy, open, onClose, onCreated }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-4 bg-[rgba(14,15,12,0.45)] dark:bg-[rgba(0,0,0,0.6)] backdrop-blur-sm" onClick={onClose}>
      <div
        className={`w-full max-w-3xl max-h-[92vh] overflow-y-auto bg-white dark:bg-[#1e201c] rounded-[24px] shadow-[0_24px_64px_rgba(14,15,12,0.25)] dark:shadow-[0_24px_64px_rgba(0,0,0,0.5)] border-t-[3px] ${ACCENT[strategy]} flex flex-col`}
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white dark:bg-[#1e201c] border-b border-[rgba(14,15,12,0.06)] dark:border-[rgba(232,235,230,0.06)]">
          <h2 className="font-black text-lg text-[#0e0f0c] dark:text-[#e8ebe6] tracking-tight">{TITLE[strategy]}</h2>
